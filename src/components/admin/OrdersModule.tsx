...
export const OrdersModule: React.FC = () => {
  ...
  const loadOrders = async () => {
    ...
    const enriched = data.map((o, idx) => ({
      ...
      agentName: (o as any).agentName || [`3 Асадулло Агент`, `5 Отабек Агент`, `11 Парвина Агент`, `TP-1 Shohijaxon`][idx % 4],
  ...
  const openEditOrderModal = async (ord: Order) => {
    ...
    setEditAgentName(ord.courierName || (ord as any).agentName || '');
                ...
                filteredOrders.map((ord: any) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Sales Agent */}
                      <td className="p-1 border-r border-slate-200 text-slate-800 whitespace-nowrap font-medium">
                        {ord.agentName}
                      </td>
