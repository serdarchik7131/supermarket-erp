import { Branch, Category, Product, Order, Courier, AuditLog, Client, StaffMember, PaymentRecord, AktSverkaEntry, Promotion, PriceType, SystemSettings, Territory } from '../types';
...
export async function askAIAssistant(prompt: string): Promise<{
  replyText: string;
